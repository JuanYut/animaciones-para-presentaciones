...
| `10-ejemplo-settimeout.html` | Ejemplo 1 (formato código + paneles, **1920×1080**) | `console.log("A"); setTimeout(() => console.log("B"), 0); console.log("C")`. Código a la izquierda con la línea resaltada; a la derecha una barra "Event Loop · orquesta todo" con el anillo girando y, debajo, Call Stack, Web APIs, Macrotask Queue y Consola. La consola imprime `A`, `C`, `B`. |
